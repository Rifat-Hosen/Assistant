                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      ...
                      children: viewModel.model.assistants.map((assistant) {
                        return NewWidget(icon_name: assistant.icon_name, name: assistant.name, isSelect: assistant.isSelect, description: assistant.description, ispro: assistant.isPro);
                      }).toList(),
                    ),
                  ),
                  Padding(
